 ...
 *
 */
public class ServiceBuilderTemp
{
     ...
     * @return the {@link ServiceBuilderTemp} instance for method chaining
     */
    public ServiceBuilderTemp provider(Class<? extends Api> apiClass)
    {
     ...
     * @return the {@link ServiceBuilderTemp} instance for method chaining
     */
    public ServiceBuilderTemp provider(Api api)
    {
     ...
     * @return the {@link ServiceBuilderTemp} instance for method chaining
     */
    public ServiceBuilderTemp callback(String callback)
    {
     ...
     * @return the {@link ServiceBuilderTemp} instance for method chaining
     */
    public ServiceBuilderTemp apiKey(String apiKey)
    {
     ...
     * @return the {@link ServiceBuilderTemp} instance for method chaining
     */
    public ServiceBuilderTemp apiSecret(String apiSecret)
    {
     ...
     * @return the {@link ServiceBuilderTemp} instance for method chaining
     */
    public ServiceBuilderTemp scope(String scope)
    {
    ...
    public ServiceBuilderTemp signatureType(SignatureType type)
    {
    ...
    public ServiceBuilderTemp debugStream(OutputStream stream)
    {
    ...
    public ServiceBuilderTemp debug()
    {
